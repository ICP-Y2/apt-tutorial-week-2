# Importing `learninglogs.sql` and `seed.sql` Using phpMyAdmin

## 📄 Overview

This guide explains how to import the `learninglogs.sql` and `seed.sql` files into your MySQL database using **phpMyAdmin**. These files are essential for initializing your database structure and preloading it with sample data.
...
|------------|-----------------------------|--------------|
| `learninglogs.sql` | Creates database structure   | First        |
...
2. **Create a New Database**  
   ...
   - Name your database (For this project setup, `learning_logs`) and click **Create**.
